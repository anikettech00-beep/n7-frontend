        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-5">
            <Image
              src="/icons/logo.svg"
              alt="logo"
              className="lg:w-auto md:w-[35%] w-[35%]"
              width={100}
              height={100}
            />
          </div>
            ...
            {officeLocations.map((office, idx) => (
              <div key={idx}>
                ...
                {office.lines.map((line, lineIdx) => (
                  <p
                    key={lineIdx}
                    className="text-white opacity-70 text-[14px] leading-relaxed"
                  >
                    {line}
                  </p>
                ))}
            ...
            <div className="sm:col-span-3 w-full pt-10 lg:pt-19.75">
              <div className=" w-full">
                <p className="text-[#E9F4F9]/30 text-[14px] w-full">
                  Copyright © 2022 by Linktia Infosystems Limited — [CB7 and N7
                  as Commercial Brand] — [Registered under the Companies Act
                  2006 in England and Wales | Number of Incorporation 13100992]
                </p>
              </div>
            </div>
          </div>
