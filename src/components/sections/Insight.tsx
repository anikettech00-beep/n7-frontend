        ...
        <section className="relative bg-[#000D12] pt-10 md:pt-20 pb-16 overflow-hidden">
            ...
            <div className="container-custom">
                    ...
                    <div className="lg:col-span-7">
                        <div className="grid md:grid-cols-2 gap-5">
                            {insights.map((item, index) => (
                                <div
                                    key={index}
                                    className={`bg-[#01141B] rounded-[18px] p-6 shadow-[0_0_40px_rgba(0,255,255,0.03)] ${index === 0 ? "md:col-span-2 md:flex gap-5 items-center" : ""
                                        }`}
                                >
                                    {/* Pattern Box */}
                                    {/* Pattern Box */}
                ...
                <div className="text-right flex justify-end">
                    <button
                        className="font-button group/link w-45 relative text-[#00B4FD] text-[14px] text-sm uppercase flex  gap-2 mt-5"
                    >
